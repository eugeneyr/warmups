...
public class HistoricalCrosswordConfiguration implements Serializable, Cloneable {
    private int width;
    private int height;
    ...
    public HistoricalCrosswordConfiguration(ShapelessWordBucket bucket, int width, int height) {
        dictionary = bucket;
        this.height = height;
        this.width = width;
    }
    ...
    @Override
    public HistoricalCrosswordConfiguration clone() throws CloneNotSupportedException {
        HistoricalCrosswordConfiguration other = (HistoricalCrosswordConfiguration) super.clone();
    ...
    public boolean isSupersetOf(HistoricalCrosswordConfiguration otherConfig) {
