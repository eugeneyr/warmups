 ...
 */
public class TopCoderCrosswordInABucket implements Cloneable {
    private int width;
    private int height;
    ...
    public TopCoderCrosswordInABucket(int width, int height) {
        this.width = width;
        this.height = height;
    }
...
//                System.out.println("** " + word + " " + playField[word.length() + x][y]);
                return false;
            }
            // placing the letters
            for (int i = 0; i < word.length(); i++) {
...
//                System.out.println("*** " + word + " " + playField[x][word.length() + y]);
                return false;
            }
...
//        return null;
    ...
    @Override
    protected TopCoderCrosswordInABucket clone() throws CloneNotSupportedException {
        TopCoderCrosswordInABucket other = (TopCoderCrosswordInABucket) super.clone();
