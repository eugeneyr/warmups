...
public class TreeConfigHolder {
    ...
    public boolean alreadyWas(BoundBoardlessCrosswordConfiguration config) {
        return alreadyWas(config, false);
    }

    public boolean alreadyWas(BoundBoardlessCrosswordConfiguration config, boolean descend) {
        if (descend) {
    ...
    public boolean descend(ConfigTreeNode node, BoundBoardlessCrosswordConfiguration config) {
        if (node == null) {
            return false;
        }
    ...
    public boolean alreadyWas(WordPosition rootWp, BoundBoardlessCrosswordConfiguration config) {
        for (ConfigTreeNode root : roots) {
    ...
    public boolean descend(WordPosition root, ConfigTreeNode node, BoundBoardlessCrosswordConfiguration config) {
        if (node == null) {
            return false;
        }
        if (node.getChildren().isEmpty()) {
