...
public class BoundBoardlessCrosswordConfiguration implements Serializable, Cloneable {
    private int width;
    private int height;
    ...
    public BoundBoardlessCrosswordConfiguration(ShapelessWordBucket bucket, int width, int height) {
        dictionary = bucket;
        this.height = height;
        this.width = width;
    }
    ...
    @Override
    public BoundBoardlessCrosswordConfiguration clone() throws CloneNotSupportedException {
        BoundBoardlessCrosswordConfiguration other = (BoundBoardlessCrosswordConfiguration) super.clone();
